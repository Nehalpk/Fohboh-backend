        ...
        try:
            ...
            with self.conn.cursor() as cur:
                ...
                for _, row in processed_df.iterrows():
                    ...
                    # Extract discount_percent (your CSV has this)
                    discount_percent = float(get_val('discount_percent', 0.0))
                    # Calculate discount_applied from discount_percent and subtotal
                    ...
                    records.append((
                        ...
                        int(get_val('covers', 0)) if get_val('covers') is not None else None,  # 20 - guest_count (from covers)
                        get_datetime('seated_time'),                       # 21 - seated_time
                        get_datetime('departure_time'),                    # 22 - departure_time
                        get_bool('was_reservation'),                       # 23 - was_reservation
                        get_datetime('order_received_time'),               # 24 - order_received_time
                        get_datetime('kitchen_start_time'),                # 25 - kitchen_start_time
